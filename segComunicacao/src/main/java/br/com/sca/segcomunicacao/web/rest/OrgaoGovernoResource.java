...
import br.com.sca.segcomunicacao.repository.OrgaoGovernoRepository;
import br.com.sca.segcomunicacao.repository.search.OrgaoGovernoSearchRepository;
...
/**
 * REST controller for managing {@link br.com.sca.segcomunicacao.domain.OrgaoGoverno}.
 */
@RestController
@RequestMapping("/api")
public class OrgaoGovernoResource {
    ...
    private static final String ENTITY_NAME = "segComunicacaoOrgaoGoverno";

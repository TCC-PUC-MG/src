...
import br.com.sca.gateway.repository.EventoRiscoRepository;
import br.com.sca.gateway.repository.search.EventoRiscoSearchRepository;
...
/**
 * REST controller for managing {@link br.com.sca.gateway.domain.EventoRisco}.
 */
@RestController
@RequestMapping("/api")
public class EventoRiscoResource {
    ...
    private static final String ENTITY_NAME = "eventoRisco";

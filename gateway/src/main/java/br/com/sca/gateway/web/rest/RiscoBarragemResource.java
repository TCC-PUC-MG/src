...
import br.com.sca.gateway.repository.RiscoBarragemRepository;
import br.com.sca.gateway.repository.search.RiscoBarragemSearchRepository;
...
/**
 * REST controller for managing {@link br.com.sca.gateway.domain.RiscoBarragem}.
 */
@RestController
@RequestMapping("/api")
public class RiscoBarragemResource {
    ...
    private static final String ENTITY_NAME = "riscoBarragem";

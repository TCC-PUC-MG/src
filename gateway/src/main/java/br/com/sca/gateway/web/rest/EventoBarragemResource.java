...
import br.com.sca.gateway.repository.EventoBarragemRepository;
import br.com.sca.gateway.repository.search.EventoBarragemSearchRepository;
...
/**
 * REST controller for managing {@link br.com.sca.gateway.domain.EventoBarragem}.
 */
@RestController
@RequestMapping("/api")
public class EventoBarragemResource {
    ...
    private static final String ENTITY_NAME = "eventoBarragem";

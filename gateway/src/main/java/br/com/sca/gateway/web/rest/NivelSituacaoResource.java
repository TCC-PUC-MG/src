...
import br.com.sca.gateway.repository.NivelSituacaoRepository;
import br.com.sca.gateway.repository.search.NivelSituacaoSearchRepository;
...
/**
 * REST controller for managing {@link br.com.sca.gateway.domain.NivelSituacao}.
 */
@RestController
@RequestMapping("/api")
public class NivelSituacaoResource {
    ...
    private static final String ENTITY_NAME = "nivelSituacao";
